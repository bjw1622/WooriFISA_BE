...
public class Basic6TypeCasting {
	...
	public static void main(String[] args) {
        ...
        // byte e = 130; // Compile Error : Incompatible types. Found: 'int', required: 'byte'
        ...
        // 예외적으로 byte나 short 타입은 별도의 리터럴 표기가 존재하지 않기 때문에 허용범위 내에서 정수형의 기본 값인 int타입의 리터럴로 저장 가능.
        // -> 6,7번 라인 참조

        // 6. 타입 변환, 형 변환(Type Casting)

        /*
            서로 다른 타입 간의 연산을 수행하기 위해서는 먼저 타입을 일치시켜야 함
            변수 혹은 리터럴(값, value)의 타입을 다른 타입으로 변환하는 것을 형 변환(Type Casting)이라고 함
         */
        ...
        double i = 5.5;
        // float j = i; // Compile Error : Incompatible types. Found: 'double', required: 'float'
        float j = (float)i;
